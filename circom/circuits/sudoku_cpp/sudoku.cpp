...
uint get_total_signal_no() {return 4539;}

uint get_number_of_components() {return 506;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 3218;}
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[6]); // line circom 112
while(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 0)]].signalStart + 0],&circuitConstants[1]); // line circom 115
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 112
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[6]); // line circom 112
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[5]); // line circom 52
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 0);
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 0)]].signalStart + 0],&circuitConstants[1]); // line circom 55
...
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[5]); // line circom 65
while(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[5];
// load src
Fr_add(&expaux[0],&lvar[5],&circuitConstants[2]); // line circom 65
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[5]); // line circom 65
...
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[5]); // line circom 74
while(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[5])) + 4)]].signalStart + 0],&circuitConstants[1]); // line circom 79
...
PFrElement aux_dest = &lvar[5];
// load src
Fr_add(&expaux[0],&lvar[5],&circuitConstants[2]); // line circom 74
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[5]); // line circom 74
...
uint csoffset = mySignalStart+2998;
uint aux_dimensions[1] = {4};
for (uint i = 0; i < 4; i++) {
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * ((Fr_toInt(&lvar[1]) * 4) + Fr_toInt(&lvar[2]))) + 1)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((4 * Fr_toInt(&lvar[1])) + (1 * Fr_toInt(&lvar[2]))) + 17)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 23
while(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 1)]].signalStart + 0],&circuitConstants[1]); // line circom 26
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((4 * Fr_toInt(&lvar[2])) + (1 * Fr_toInt(&lvar[1]))) + 17)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
SubgroupVerifier_8_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 5)]].signalStart + 0],&circuitConstants[1]); // line circom 36
